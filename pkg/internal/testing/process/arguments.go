...
// EnableFlag configures the given key to be passed as a "name-only" flag,
// like, `--key`.
func (a *Arguments) EnableFlag(key string) *Arguments {
...
// to intentionally ignore defaults/start from scratch, call AppendOverridingDefaults.
//
